...
public class PCivil extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_PCIVIL);
    ...
    private void uploadFile(Uri data) {
        ...
        final  StorageReference sRef = mStorageReference.child(Constants.STORAGE_PATH_PCIVIL + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.textViewUploads:
                startActivity(new Intent(this, ViewFiles6.class));
                break;
        }
    }
}
