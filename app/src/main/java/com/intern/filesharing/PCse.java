...
public class PCse extends AppCompatActivity implements View.OnClickListener{
    ...
    private void uploadFile(Uri data) {
        ...
        final  StorageReference sRef = mStorageReference.child(Constants.STORAGE_PATH_PCSE + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.textViewUploads:
                startActivity(new Intent(this, ViewFiles7.class));
                break;
        }
    }
}
