...
public class CseFiles extends AppCompatActivity implements View.OnClickListener{
    ...
    //these are the views
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_CSE);
        ...
        private void uploadFile(Uri data) {
          ...
          final  StorageReference sRef = mStorageReference.child(Constants.STORAGE_PATH_CSE + System.currentTimeMillis() + ".pdf");
            sRef.putFile(data)
