...
public class Mba extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_MBA);
    ...
    private void uploadFile(Uri data) {
        ...
        final  StorageReference sRef = mStorageReference.child(Constants.STORAGE_PATH_MBA + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.textViewUploads:
                startActivity(new Intent(this, ViewFiles3.class));
                break;
        }
    }
}
